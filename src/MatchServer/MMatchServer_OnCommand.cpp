		...
		case MC_MATCH_LOGIN_FROM_DBAGENT:
			{
				...
				if(strstr(szLoginID, "%")) break;
				if(strstr(szName, "%")) break;
		...
		case MC_MATCH_USER_WHISPER:
			{
				...
				if(strstr(szSenderName, "%")) break;
				if(strstr(szTargetName, "%")) break;
				if(strstr(szMessage, "%")) break;
		...
		case MC_MATCH_CHATROOM_CREATE:
			{
				...
				if(strstr(szChatRoomName, "%")) break;
		...
		case MC_MATCH_CLAN_REQUEST_AGREED_CREATE_CLAN:
			{
				...
				if(strstr(szSponsorNames, "%")) break;
